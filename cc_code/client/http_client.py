"""HTTP client for CC Code Python - connects to FastAPI backend"""
...
class CCCodeHttpClient:
    """HTTP client for CC Code TUI."""
    ...
    async def __aenter__(self) -> "CCCodeHttpClient":
        await self.connect()
        return self
    ...
    async def create_session(self, working_directory: str = "") -> str:
        ...
        from cc_code.core.messages import generate_uuid
