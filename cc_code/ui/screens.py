...
from cc_code.ui.widgets import WelcomeWidget, InputTextArea
...
from cc_code.ui.session_resume_modal import SessionResumeModal
...
class REPLScreen(Screen):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._history_file = Path.home() / ".cc-py/input_history.json"
        self._load_history()
